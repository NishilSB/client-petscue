...
const RescueComponent = () => {
  ...
  const healthConditionArray=["No Body Damage","Need Urgent Help"]
  ...
  const handleSubmit = async (e) => {
    ...
    if (
      ...
      try {
        axiosInstance.post("/user/rescueForm", {
          name,
          phone,
          district,
          date,
              ...
              <div className=" w-4/5 h-full flex justify-center items-start  mx-8">
                <div className="flex flex-col items-center justify-center">
                  ...
                  >
                    ...
                    {healthConditionArray.map((health)=>{
                      return <option key={health} value={health}>{health}</option>
                    })}
                  </select>
                </div>
              </div>
